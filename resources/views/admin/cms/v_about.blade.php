    ...
    <section class="home-section">
      ...
      <main>
          <div class="container-fluid">
              <br>
              @foreach($about as $v_about)
                <form action="/update_about/{{ $v_about->id }}" method="post" enctype="multipart/form-data">
                @csrf
                    <input type="text" class="form-control" name="name_website" value="<?= $v_about->name_website ?>"><br>
                    <input type="text" class="form-control" name="phone" value="<?= $v_about->phone ?>">
                    <p>(Format Telp Wajib Diisi: +62)</p><br>
                    <div align="right">
