...
<body>
    ...
    <section class="home-section">
      ...
      <main>
        ...
        <br>
            <form action="{{ url('proccess_update_dev/'.$data->iddeveloper) }}" method="post">
                @csrf
                @method('PUT')
                <input type="hidden" name="iddeveloper" class="form-control" value="{{ $data->iddeveloper }}">
                <label>Nama Developer :</label>
                <input type="text" class="form-control" name="developer_name" value="{{ $data->developer_name }}"><br>
                <div align="right">
