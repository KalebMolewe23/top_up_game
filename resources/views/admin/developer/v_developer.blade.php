      ...
      <main>
        ...
        <table class="table table-striped">
                <thead>
                    <tr>
                        <th scope="col">No. </th>
                        <th scope="col">Nama Developer</th>
                        <th scope="col">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    <?php $no = 1; ?>
                    @foreach ($developer as $v_dev)
                    <tr> 
                        <td><?= $no++; ?></td>
                        <td>{!! $v_dev->developer_name; !!}</td>
                        <td>
                            <a href='{{ url("edit_dev/".$v_dev->iddeveloper) }}' class="btn btn-warning btn-sm">Ubah</a>
                            <form class="d-inline" action="{{ url('delete_dev/'.$v_dev->iddeveloper) }}" method="post">
                                @csrf
                                @method('DELETE')
